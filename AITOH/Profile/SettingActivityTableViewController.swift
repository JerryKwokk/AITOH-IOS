...
class SettingActivityTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = DeviceView.dequeueReusableCell(withIdentifier: "SettingLoginActivityTableCellTableViewCell") as! SettingLoginActivityTableCellTableViewCell
